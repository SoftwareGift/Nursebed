package com.bendian.nursingbed.view.sliding;
//添加测试编译注释
...
public class DragLayout extends FrameLayout {
    ...
    private final ViewDragHelper.Callback dragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewPositionChanged(View changedView, int left, int top,
            ...
            if (changedView == vgLeft) {
                ...
                vgMain.layout(mainLeft, 0, mainLeft + vgMain.getMeasuredWidth(), height);
            }
    ...
    protected void onFinishInflate() {
        ...
        //左侧界面
        vgLeft = (ViewGroup) getChildAt(0);
        //右侧(主)界面
        vgMain = (CustomRelativeLayout) getChildAt(1);
        vgMain.setDragLayout(this);
        vgLeft.setClickable(true);
        vgMain.setClickable(true);
    }

    public View getVgMain() {
        return vgMain;
    }

    public View getVgLeft() {
        return vgLeft;
    }
